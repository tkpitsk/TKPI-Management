                                        ...
                                        <td className="px-5 py-4">
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                {user.isActive ? (
                                                    ...
                                                    <button
                                                        onClick={() => handleToggleStatus(user)}
                                                        className="inline-flex items-center gap-1 rounded-xl border border-green-200 bg-green-50 px-3 py-2 text-xs font-medium text-green-700 transition hover:bg-green-100"
                                                    >
                                                        <BadgeCheck size={14} />
                                                        Activate
                                                    </button>
