...
export default function BrandQuickAdd({
    onClose,
    onSuccess
}: {
    onClose: () => void;
            ...
            <div className="bg-white w-full max-w-md rounded-[32px] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                <div className="flex items-center justify-between border-b border-border p-6 bg-muted/20">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-lg font-bold text-text">Quick Add Brand</h3>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                    <div className="space-y-2">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-text-muted">Brand Name</label>
                        <input
                            required
                            value={form.name}
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-text-muted">Country of Origin</label>
                        <input
                            value={form.country}
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            placeholder="Brand history, quality standards..."
                        />
                    </div>
